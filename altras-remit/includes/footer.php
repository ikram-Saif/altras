        ...
        <div class="flex">
            <div class="col">
                <div class="inner">
                    <h4>Legal</h4>
                    <ul class="lst">
                        <li><a target = '_blank' href="antiMoney.php">Anti Money Laundering</a></li>
                        <li><a target = '_blank' href="complaintPolicy.php">Complaint Policy</a></li>
                        <li><a target = '_blank'  href="consumerProtection.php">Consumer Protection</a></li>
                        <li><a target = '_blank' href="privacy-policy.php">Privacy Policy</a></li>
                        <li><a target = '_blank' href="terms-of-use.php">Terms & Conditions</a></li>
                    </ul>
                </div>
            </div>
            <div class="col">
                <div class="inner">
                    <h4>Address</h4>
                    <ul class="lst">
                        <li>56 Castleriada Grove, Ballyowen, Lucan, Co. Dublin, K78 W584, Ireland</li>
                    </ul>
                </div>
            </div>
            <div class="col">
                <div class="inner">
                    <h4>Contact Info</h4>
                    <ul class="lst flagLSt flex" id = 'numbers'>
                        <li><span><img src="<?= $baseurl ?>images/gb.svg"></span><a href="tel:+441217730218">+441217730218</a></li>
                        ...
                        <li><span><img src="<?= $baseurl ?>images/it.svg"></span><a href="tel:+390689587014">+3968958014</a></li>
                        <li style = "width:55%"><span><i class="fa fa-envelope-o"></i></span><a href="" class="footerMailLnk">info@altrasremit.com</a></li>
                    </ul>
                </div>
            </div>
                ...
                <div class="inner">
                    ...
                    <form action="" method="post">
                        ...
                        <div class="inside">
                            ...
                            <button type="submit" class="webBtn blueBtn" disabled>Subscribe!</button>
                        </div>
                    </form> -->
    ...
    <div class="copyright relative">
        <div class="contain">
            <div class="inner semi">
                <p>All rights reserved &copy; to Altras Remit Limited</p>
