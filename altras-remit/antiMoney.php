...
<html>
<head>
<title>Anti Money Laundering – Altras.</title>
...
<section class="cmnSec txtCntnt">
    <div class="contain">
        <div class="txtCntntBody ckEditor">
            <h3>MONEY LAUNDERING STATEMENT</h3>
            <p>
            ...
            As an Authorised Payment Institution, Altras Remit Ltd recognises that, we are at risk of being exploited by money launderers. We fully recognise that we have legal obligations to do all we can to prevent the abuse of our services. Money laundering is a serious threat to financial system of all countries, and it leads to destruction of the country’s sovereignty and character. The prevention of money laundering is a key focus of regulatory authorities with robust money laundering regulations present designed to inhibit the movement of funds derived from criminal activity and to restrict the availability of money to fund terrorist activities
                ...
                <p>Altras Remit Ltd views money laundering as a serious criminal offence and is committed to preventing money laundering through its service, and as such, complies strictly with the regulatory requirements including taking such measures as the following: </p>
                <ul>
                    <li>
                    ...
                    <li>
                        Appointing a nominated officer responsible for monitoring and reporting all suspicious activities to the relevant authorities                </li>
                    </li>
            </ul>

            <h3>IDue Diligence and KYC (Know Your Customer)</h3>
            <p>
            ...
            <h4 class = "bold">Identification Requirement</h4>
            <p>
            ...
            <h4 class = "bold">Proof of ID:</h4>
            <ul>
                <li>Passport</li>
                <li>UK or EEA Driving License</li>
                <li>EU National Identity Card</li>
                <li>Residence Permit issued by the Home Office</li>
            </ul>
         
            <h4 class = "bold">Proof of Address:</h4>
            <ul>
                <li>Utility bill (issued within the last three months)</li>
                <li>Local council tax bill (issued within the current tax year).</li>
                <li>UK driving license (only if not used for Proof of ID).</li>
                <li>Bank, Building Society or Credit Union statement (issued within the last three months).</li>
                <li>Housing agreement from local authorities (issued within the current year).</li>
            </ul>
            <p>
            ...
            <p>This Acceptable Use Policy sets out the terms under which you may access our Services and applies as soon as you access and/or use Altras Remit Ltd.</p>
            <p>
            ...
            <h4 class = "bold">Unsupported businesses and transactions</h4>
            <p>You may not use Altras Remit services in connection with any activity, product, service, or transaction that violates any law, government regulation or promotes or facilitates the violation of any law or regulation. Additionally, you may not use Altras Remit service in connection with any of the following categories of businesses and practices. The types of businesses listed below are representative but not exhaustive, and we reserve our right to deny our services to any customers who exceed our risk tolerance. If you are uncertain as to whether your transaction is prohibited by Altras Remit or have questions about how these requirements apply to you, please contact us at compliance@altras.co.uk or by telephone at 0121 773 0218. </p>
                <ul>
                <li>Adult Content</li>

                <li>Alcohol Business</li>

                <li>Ammunition, firearms, or certain firearm parts or accessories</li>

                <li>Cannabis industry and other recreational drugs</li>

                <li>Chemicals</li>

                <li>Counterfeit or unauthorised goods</li>

                <li>Credit repair companies and debt settlement services</li>

                <li>Embassies/Consulates</li>

                <li>Financial services operating without a license where one is required</li>

                <li>Gambling</li>

                <li>Individuals, entities, or countries subject to international sanctions</li>

                <li>Intellectual property or proprietary rights infringement</li>

                <li>Military and semi-military goods and services</li>
                <li>Money Service Businesses </li>
                <li>Multi-level marketing, pyramid schemes, get rich quick schemes, referral marketing.</li>
                <li>Narcotics</li>
                <li>Nonprofit organisations and charities</li>
                ...
                <p>Altras Remit Ltd is committed to ensure the highest ethical professional standards in the conduct of its business activities. The adoption of this policy is aimed at increasing awareness of money laundering activity, its ill effects and to simultaneously counter money laundering in a significant way.
                </p>
                <p>
        ...
        <div class="sideMobileIntro">
            ...
            <div class="bTn mobileAppBtns">
                        <a href = 'https://play.google.com/store/apps/details?id=moneytransfers.altras.co.uk.altrasmoneytransfers&hl=en_US&gl=US' class="webBtn">
                        ...
                        <a  href = 'https://apps.apple.com/us/app/altras-money-transfer/id1378281180' class="webBtn">
