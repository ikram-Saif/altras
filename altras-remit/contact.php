		...
		<div class="flex">
           ...
           <p>Whether you have a question about features, trials, pricing, need a demo, or anything else, our team is ready to answer all your questions</p>
			...
			<div class="cmnFnt">
				...
				<ul class="infoLst">
					<li><i class="fi-map-marker"></i><span>56 Castleriada Grove, Ballyowen, Lucan, Co. Dublin, K78 W584, Ireland </span></li>
					<li><i class="fi-envelope"></i><a >info@altrasremit.com</a></li>
					<li><i class="fi-globe"></i><a href="http://www.altras.co.uk/">www.altrasremit.com</a></li>
					<li><i class="fi-phone"></i><a >+35316571584</a></li>
				</ul>
			</div>
	    </div>
